...
import com.docs.scanner.domain.usecase.document.UpdateDocumentUseCase  // ✅ ADD
...
import com.docs.scanner.domain.usecase.record.MoveRecordToFolderUseCase  // ✅ ADD
...
import com.docs.scanner.domain.usecase.term.GetCompletedTermsUseCase  // ✅ ADD
import com.docs.scanner.domain.usecase.term.GetUpcomingTermsUseCase
import com.docs.scanner.domain.usecase.term.MarkTermCompletedUseCase  // ✅ ADD
...
data class AllUseCases @Inject constructor(
    ...
    val moveRecord: MoveRecordToFolderUseCase,  // ✅ ADDED
    
    // ============================================
    // DOCUMENTS (10 Use Cases) ✅ +1
    // ============================================
    val getDocuments: GetDocumentsUseCase,
    val getDocumentById: GetDocumentByIdUseCase,
    val addDocument: AddDocumentUseCase,
    val updateDocument: UpdateDocumentUseCase,  // ✅ ADDED
    ...
    val getCompletedTerms: GetCompletedTermsUseCase,  // ✅ ADDED
    val createTerm: CreateTermUseCase,
    val updateTerm: UpdateTermUseCase,
    val deleteTerm: DeleteTermUseCase,
    val markTermCompleted: MarkTermCompletedUseCase,  // ✅ ADDED
